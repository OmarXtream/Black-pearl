$(function () {
  ...
  // $('.rules .rChoose').on('click', function () {

  //   $(".rules .rChoose").removeClass("active");

  //   $(this).addClass('active');

  //   var tog = $(this).data("class");

  //   animateCSS(".rules .rulesS", "fadeOut", function() {

  //     $(".rules .rulesP").addClass("d-none");
